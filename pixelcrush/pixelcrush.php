...
class Pixelcrush extends Module
{
    ...
    public function getProductsThumbsSize() {
        $bytes = 0;
        $nb = 0;
    ...
    public function displayForm()
    {
        ...
        $fields_form[0]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    'type'    => 'switch',
                    'label'   => $this->l('Prevent creation of new Thumbnails'),
                    'desc'    => $this->l('Thumbnail files are not longer needed while Image CDN is enabled.'),
        ...
        if (!Configuration::get('PIXELCRUSH_ENABLE_IMAGES')) {
            ...
            $fields_form[0]['form']['input'] = array_splice($inputs, 0, 1) + array_splice($inputs, 1);
        }
